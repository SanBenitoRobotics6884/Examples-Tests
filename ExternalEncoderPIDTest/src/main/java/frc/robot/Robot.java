...
public class Robot extends TimedRobot {
  ...
  private static double kSpeed = 0.5;
  private static double setpoint = 2000;
  ...
  public void teleopPeriodic() {
    if (m_controller.getRawButton(1)) {
      //m_motor.set(pid.calculate(encoder.getRate() * 60, setpoint) + 0.04);
      m_motor.set(m_controller.getY() * kSpeed);
    } else {
      m_motor.set(0);
    }
    ...
    SmartDashboard.putNumber("Encoder Rate", encoder.getRate() * 60);
  }
